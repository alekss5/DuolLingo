  ...
  return (
    <SafeAreaView>
      <View style={styles.animationFinisContainer}>
        <LottieView source={finishText} autoPlay loop={true} />
      </View>
      <View style={styles.finishAnimationContainer}>
        <LottieView source={finishAnimation} autoPlay loop={true} />
      </View>
      <Text style={styles.text}>
        Finish
        <Text style={{ color: GlobalStyles.colors.accentOrange }}>
          3 lesons
        </Text>
        to start competing on Leaderborad
      </Text>
    </SafeAreaView>
  );
}
